...
const AdminDashboard = () => {
  ...
  const VILLA_NAMES = ['Palacio Tropical', 'Palacio Musical', 'The View House'];
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {['Palacio Tropical', 'Palacio Musical', 'The View House'].map(villa => (
