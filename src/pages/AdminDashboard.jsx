  ...
  const BLOG_TEMPLATES = [
    { label: '-- Load a template --', value: '' },
    {
      ...
      value: {
        ...
        text: `Palacio Musical: The Only Luxury Beachfront Villa with a Professional Recording Studio in Costa Rica\n\nImagine waking up to the sound of the Pacific, stepping onto your private ocean-view deck with a coffee in hand -- and then heading downstairs to record in a fully equipped professional studio. That's the reality at Palacio Musical, the most unique luxury villa in Costa Rica.\n\nA Villa Built for Creatives\n\nPalacio Musical is a 12,500 sq ft beachfront estate in Tambor, Puntarenas -- one of Costa Rica's most pristine and private coastlines. With 7 en-suite bedrooms, three ocean-view decks, a whale watching observatory, and a Tiki Bar, it's already one of the finest private villas in Central America.\n\nBut its most remarkable feature is its professional music studio -- a fully equipped recording space embedded within a luxury beach house. There is nowhere else in the world quite like it.\n\nWho Stays at Palacio Musical?\n\nPalacio Musical attracts a rare kind of guest:\n\n- Recording artists and bands seeking an inspiring, private studio session\n- Music producers looking to create away from city distractions\n- Labels organizing artist residencies or album recording trips\n- Music-focused content creators and influencers\n- Corporate groups in the creative industry seeking an unforgettable retreat\n\nThe villa accommodates up to 18 overnight guests -- ideal for a band plus their team, or a group of collaborators working together.\n\nThe Setting Makes the Music\n\nCreativity doesn't happen in a vacuum. Palacio Musical's setting -- humpback whales breaching just offshore, howler monkeys calling at dawn, the Pacific turning gold at sunset -- is genuinely unlike anywhere else.\n\nThe Villa at a Glance\n\n- Size: 12,500 sq ft\n- Bedrooms: 7 en-suite\n- Guests: up to 18\n- Professional Music Studio\n- Three ocean-view decks\n- Whale Watching Observatory with Tiki Bar\n- Direct secluded beach access\n- Full staff: chef, housekeeping, concierge\n- Enhanced security\n- Combinable with adjacent Palacio Tropical for groups up to 36\n\nLocation\n\nTambor, Nicoya Peninsula -- 30-minute flight from San Jose. Santa Teresa is just 35 minutes away.\n\nNightly rates from $2,700 in low season. Download our free Pricing Guide at executivevacations.net/pricing.`,
      },
    },
    {
      ...
      value: {
        ...
        metaDesc: 'Planning a group trip to Costa Rica? Discover the best luxury villa rentals for 10-36 guests -- private pools, full staff, beachfront access & concierge service.',
        focusKeyword: 'Costa Rica luxury villa large group rental',
        text: `Costa Rica Luxury Villa Rental for Large Groups: The Complete 2026 Guide\n\nCosta Rica has become one of the world's top destinations for group travel -- warm year-round weather, extraordinary biodiversity, world-class beaches, and some of the most spectacular private villa rentals on the planet.\n\nWhy a Private Villa Beats a Hotel for Groups\n\nAt a private villa, your group has the entire property to yourselves. Multiple living areas, a private pool, communal dining, and shared outdoor spaces create the kind of group experience that bonds people -- and creates memories that last decades.\n\nOur Villas for Large Groups\n\nPalacio Tropical (up to 18 guests) -- Our flagship 7-bedroom, 10,500 sq ft beachfront estate. Direct secluded beach access, resort-style pool, full staff, and VIP-grade security.\n\nPalacio Musical (up to 18 guests) -- A 12,500 sq ft oceanfront villa with three panoramic decks, a whale watching observatory, and a professional recording studio.\n\nThe View House (up to 10 guests) -- A beautifully designed 4-bedroom villa with spectacular Pacific ocean views. Intimate and modern.\n\nThe Palms Villa Estate (up to 10 guests) -- A lush tropical estate surrounded by gardens with a large private pool.\n\nCombining Villas for Groups of 20-36\n\nAll four villas are located close together and can be booked in combination. Palacio Tropical and Palacio Musical together accommodate up to 36 overnight guests -- perfect for large families, corporate incentive trips, or destination events.\n\nWhat's Included\n\n- Private pool exclusive to your group\n- Full staff: private chef, butler, housekeeping, security, concierge\n- Airport transfer coordination\n- Activity and excursion planning\n- 24/7 concierge support\n\nBest Group Travel Ideas\n\n- Multi-family vacation\n- Corporate retreat\n- Creative and music industry retreat\n- Bachelor and bachelorette parties\n- Milestone birthday celebrations\n\nDownload our free Pricing Guide at executivevacations.net/pricing for exact villa rates and seasonal availability.`,
      },
    },
    {
      ...
      value: {
        ...
        text: `Whale Watching in Tambor, Costa Rica: The Ultimate Guide\n\nOn the sheltered shores of Tambor Bay on the Nicoya Peninsula, one of nature's most breathtaking spectacles unfolds every year: humpback whales arrive to breed and birth in the warm Pacific waters, often just metres from shore.\n\nWhen Do Whales Visit Tambor?\n\n- North Pacific humpbacks: December through April\n- South Pacific humpbacks: July through October\n\nThis gives Tambor one of the longest whale watching seasons anywhere in the world -- up to 8 months per year. Peak months are August through October, when South Pacific humpbacks arrive in greatest numbers, often with their calves.\n\nWhat You'll See\n\n- Full breaches -- the whale launching completely out of the water\n- Spy-hopping -- the whale raising its head vertically out of the sea\n- Tail-slapping and pectoral fin waving\n- Mother and calf pairs swimming close to shore\n\nWatching From Your Villa\n\nHumpbacks regularly approach within a few hundred metres of the shoreline -- close enough to watch from your private villa terrace.\n\nPalacio Musical's Whale Watching Observatory with Tiki Bar is specifically designed for this purpose -- imagine watching a full breach while sipping a cocktail as the sun drops behind the Pacific horizon. Palacio Tropical's elevated terrace and beach access offer the same extraordinary experience.\n\nWhale Watching Tours from Tambor\n\n- Small-group catamaran tours (2-4 hours)\n- Private boat charters via our concierge\n- Kayaking tours during peak season\n\nOther Wildlife at Tambor\n\nBottlenose dolphins (year-round), sea turtles (July-October), scarlet macaws, and howler monkeys are regular sightings for villa guests.\n\nWhere to Stay\n\nPalacio Tropical from $2,400/night. Palacio Musical from $2,700/night. Download our free Pricing Guide at executivevacations.net/pricing for whale season availability.`,
      },
    },
    {
      ...
      value: {
        ...
        metaDesc: "Tambor is Costa Rica's most exclusive luxury destination -- pristine bay, humpback whales, private beachfront villas & 35 min from Santa Teresa. Discover why.",
        focusKeyword: 'Tambor Costa Rica luxury vacation',
        text: `Tambor, Costa Rica: The Nicoya Peninsula's Best-Kept Luxury Secret\n\nWhile Santa Teresa and Montezuma attract the crowds, a short drive south on the Nicoya Peninsula reveals something rarer: Tambor Bay -- a pristine, sheltered crescent of coastline that offers everything Costa Rica promises, without the noise.\n\nThis is where discerning travellers, dignitaries, and those who truly understand luxury have been quietly escaping for years.\n\nWhat Makes Tambor Different\n\n- A calm, sheltered bay with warm Pacific water year-round\n- Humpback whales visiting from offshore, up to 8 months a year\n- Scarlet macaws flying over white sand beach at sunrise\n- Jungle-backed coastline with virtually no development\n- Total privacy for families, groups, and those who require discretion\n\nGetting to Tambor\n\n- By air: 30-minute flight from San Jose (SJO) to Tambor (TMU)\n- By road: scenic drive via the Puntarenas ferry (approx. 3 hours)\n- By private transfer: we coordinate door-to-door service for all villa guests\n\nWhat to Do in Tambor\n\nNature and Wildlife: whale watching, Curu National Wildlife Refuge, sea turtle watching (July-Oct), scarlet macaw walks.\n\nAdventure: ATV tours, zip-lining, horseback riding on the beach, sport fishing, catamaran tours to Isla Tortuga.\n\nRelaxation: private pool time, beach yoga, massage and wellness services, sunset cocktails from your ocean-view terrace.\n\nDay Trips: Santa Teresa (35 min) for world-class surf and dining; Montezuma (45 min) for its famous waterfall; Cabo Blanco Nature Reserve.\n\nStay in Tambor\n\nExecutive Vacations Costa Rica manages four exclusive private villas in Tambor -- Palacio Tropical, Palacio Musical, The View House, and The Palms Villa Estate -- accommodating up to 36 overnight guests combined.\n\nDownload our free Pricing Guide at executivevacations.net/pricing to check availability.`,
      },
    },
    {
      ...
      value: {
        ...
        text: `The View House: A Luxury Ocean-View Villa Near Santa Teresa, Costa Rica\n\nSanta Teresa has become Costa Rica's most celebrated destination -- world-class surf, acclaimed restaurants, yoga retreats, and a vibrant creative scene. But for those who want complete privacy, a private pool, and views that take your breath away, the answer is 35 minutes down the road.\n\nIntroducing The View House\n\nThe View House is a beautifully designed, newly constructed luxury villa perched above the Pacific with some of the most spectacular ocean views in Costa Rica. Part of the Executive Vacations portfolio in Tambor, it is close enough to Santa Teresa for a perfect day trip -- and far enough away for complete serenity.\n\nThe Villa\n\n- Size: 2,400 sq ft of contemporary design\n- Bedrooms: 4, each thoughtfully designed\n- Guests: up to 10\n- Private swimming pool with Pacific ocean views\n- Multiple terraces and outdoor living areas\n- Whale watching opportunities from the property\n- Fully equipped modern kitchen\n- Air conditioning throughout\n\nThe Perfect Base for Exploring Santa Teresa\n\nSanta Teresa is just 35 minutes away:\n- Surf world-class waves at Playa Santa Teresa or Playa Hermosa\n- Take a sunrise yoga class on the beach\n- Dine at some of Costa Rica's finest restaurants\n- Explore boutiques, art galleries, and independent shops\n\nPart of the Executive Vacations Family\n\nThe View House is located just 5 minutes from Palacio Tropical and Palacio Musical. It can be booked alongside one or both flagship estates for larger groups (up to 46 guests combined). Our concierge team serves all properties -- so View House guests enjoy the same 24/7 service, activity coordination, and airport transfers.\n\nDownload our free Pricing Guide at executivevacations.net/pricing for exact rates and seasonal availability.`,
      },
    },
  ];
  const WEDDING_BLOG_TEMPLATES = [
    ...
    },
    {
      ...
      value: {
        ...
        metaDesc: "Not all all-inclusive wedding packages are equal. Here's exactly what a genuine Costa Rica wedding package should include -- and the red flags to avoid.",
        focusKeyword: 'all-inclusive wedding package Costa Rica',
        site: 'wedding',
        text: `All-Inclusive Wedding Package in Costa Rica: What to Look For (and What to Avoid)\n\nThe phrase "all-inclusive" sounds reassuring. But not all packages are equal -- and the difference between a genuinely comprehensive package and a misleading one can add tens of thousands of dollars to your final bill.\n\nWhat Should Be Included: The Full Checklist\n\nVenue:\n- Exclusive property use\n- Ceremony space setup\n- Reception and dining areas\n- Pool and beach access\n- Accommodation for overnight guests\n\nFood and Beverage:\n- Welcome cocktail hour\n- Full brunch every morning\n- Sit-down wedding dinner\n- Wine, beer, and beverages throughout\n- Dietary accommodations at no extra charge\n\nStaff and Service:\n- Private chef and catering team\n- Butler service\n- Daily housekeeping\n- On-site security\n- Dedicated concierge throughout\n\nRed Flags to Watch For:\n- Per-person pricing that escalates rapidly\n- Venue fee charged separately from catering\n- Beverage package sold as an add-on\n- Staff fees listed separately\n- Setup fee for ceremony decor\n- Minimum spend clauses not disclosed upfront\n\nHow Our Packages Are Structured\n\nSilver -- From $17,900. 2 nights, up to 30 ceremony guests.\nGold -- From $26,900. 3 nights, up to 50 ceremony guests.\nPlatinum -- From $63,900. 5 nights, Palacio Musical + Palacio Tropical, up to 75 ceremony guests.\nDiamond -- From $101,900. 7 nights, all four villas, up to 100 ceremony guests + private catamaran.\n\nWhen you read the price, you know the price. No hidden fees, no per-person surprises, no add-on charges.\n\nDownload our free Wedding Packages and Pricing Guide at executivevacations.net/wedding-packages to compare all four packages and request your dates.`,
      },
    },
    {
      ...
      value: {
        ...
        metaDesc: "Thinking of getting legally married in Costa Rica? Here are the real requirements -- and why most destination wedding couples choose a simpler approach.",
        focusKeyword: 'getting married in Costa Rica requirements',
        site: 'wedding',
        text: `Getting Married in Costa Rica: Legal Requirements Explained (And What Most Couples Actually Do)\n\nOne of the first questions couples ask when planning a destination wedding in Costa Rica is: "Can we get legally married there?" The answer is yes. But there is also a very popular alternative worth understanding.\n\nOption 1: Legally Marry in Costa Rica\n\nCosta Rica fully recognizes civil and religious marriages performed by registered officiants. Both partners typically need:\n\n- Valid passport\n- Birth certificate (apostilled / certified for international use)\n- If previously married: divorce decree or death certificate (apostilled)\n- Legal name and personal details of two witnesses\n- A locally registered officiant or civil registry notary\n\nDocuments in languages other than Spanish must be officially translated. Plan at least 2-3 months ahead.\n\nOption 2: Legal Ceremony at Home, Symbolic Ceremony in Costa Rica\n\nThis is by far the most popular approach for destination wedding couples.\n\nHow it works:\n- A small legal ceremony at home before your Costa Rica trip\n- Your Costa Rica wedding is a full, elaborate ceremony -- vows, rings, officiant, speeches, celebration -- simply without the legal paperwork\n- Guests experience a complete, beautiful wedding\n\nMany couples find this liberating. You focus entirely on the experience -- the ceremony on the beach, the celebration, the people -- without any administrative stress during your stay.\n\nSame-Sex Marriage in Costa Rica\n\nCosta Rica legalized same-sex marriage in May 2020 -- the first country in Central America to do so. All couples have identical legal rights and processes.\n\nThe Officiant\n\nWe work with experienced bilingual officiants who craft ceremonies that truly reflect your relationship -- from traditional and religious to modern and deeply personal.\n\nDownload our free Wedding Packages and Pricing Guide at executivevacations.net/wedding-packages or contact us directly to discuss your vision.`,
      },
    },
    {
      ...
      value: {
        ...
        metaDesc: 'Comparing Costa Rica wedding venues? We break down the real differences between private estates, resorts, and public beaches -- privacy, cost, service & experience.',
        focusKeyword: 'Costa Rica wedding venue comparison',
        site: 'wedding',
        text: `Costa Rica Wedding Venue: Private Estate vs. Resort vs. Public Beach\n\nChoosing your venue is the single most important decision in destination wedding planning. In Costa Rica, three main options exist -- and they offer genuinely different experiences.\n\nOption 1: Private Estate -- The Gold Standard\n\nAt a private estate like Palacio Musical or Palacio Tropical, the entire property is exclusively yours.\n\nAdvantages:\n- Complete privacy -- no hotel guests, no shared spaces\n- Guests sleep, eat, and celebrate in the same property\n- Private chef and fully personalized catering\n- Total flexibility on timing -- no curfews or hotel restrictions\n- All-inclusive packages eliminate hidden costs\n- Multiple ceremony and reception settings within one property\n\nBest for: Couples who prioritize privacy, personalization, and a cohesive guest experience.\n\nOption 2: Resort or Hotel Venue\n\nAdvantages:\n- Established infrastructure for large events\n\nDisadvantages:\n- You share the property with all other hotel guests\n- Another event may be happening on the same day\n- Standardized catering menus with limited personalization\n- Per-person pricing adds up quickly\n- Hotel rules and curfews limit the celebration\n\nBest for: Very large weddings where raw capacity is the primary concern.\n\nOption 3: Public Beach\n\nAdvantages:\n- Maximum natural setting, lower headline cost\n\nDisadvantages:\n- Permits required from local authorities\n- No facilities on-site\n- Public access cannot be restricted in Costa Rica\n- All logistics must be brought in and removed\n\nBest for: Ultra-informal micro-ceremonies only.\n\nOur Recommendation\n\nFor most couples, a private estate delivers the best combination of experience, flexibility, privacy, and value. Our Tambor estates have hosted weddings for couples from across the world, consistently receiving the highest reviews.\n\nDownload our free Wedding Packages and Pricing Guide at executivevacations.net/wedding-packages to see what is included and request your preferred dates.`,
      },
    },
    {
      label: "Your wedding guests will love Costa Rica -- here's why",
      value: {
        title: "Your Wedding Guests Will Love Costa Rica -- Here's Exactly Why",
        ...
        site: 'wedding',
        text: `Your Wedding Guests Will Love Costa Rica -- Here's Exactly Why\n\nWhen couples announce a destination wedding, the immediate internal question from guests is almost always: "Do I really have to travel all that way?" By the end of a Costa Rica destination wedding, those same guests are typically the loudest advocates.\n\n1. It's More Accessible Than They Think\n\nNon-stop flights from major US cities reach San Jose (SJO) in 3-4 hours. From there, a 30-minute domestic flight to Tambor or a scenic 3-hour drive via the Puntarenas ferry. We coordinate all guest transfers.\n\n2. The Setting Is Genuinely Extraordinary\n\nYour guests have probably been to weddings in hotels, barns, and country clubs. They have almost certainly never attended a wedding at a private beachfront estate with humpback whales visible offshore. The moment guests arrive at Palacio Tropical or Palacio Musical and step onto an ocean-view terrace is one of those moments people talk about for years.\n\n3. They Get a Full Vacation, Not Just a Wedding\n\nFor most guests, a destination wedding is an invitation to take a trip they would not have taken on their own. Costa Rica delivers:\n- World-class surfing (Santa Teresa is 35 minutes away)\n- ATV tours, zip-lining, whale watching, yoga retreats\n- Extraordinary wildlife -- scarlet macaws, howler monkeys, sea turtles\n- Acclaimed restaurants and vibrant beach culture\n\n4. They Stay in a Villa Together\n\nThe communal aspect of a private estate creates something hotels cannot replicate: the experience of your entire group living together in a spectacular home. Morning coffee on the terrace, a group swim before lunch, late-night conversations on the beach -- these shared moments are often what guests remember most.\n\n5. The Food Is Remarkable\n\nOur private chefs create bespoke menus from Costa Rica's exceptional fresh produce -- Pacific seafood, tropical fruits, and local ingredients. The food is consistently one of the most praised highlights.\n\n6. They'll Try to Book Their Own Trip Before They Leave\n\nThis is perhaps the most consistent feedback we receive: guests requesting villa pricing before they have even departed. A Costa Rica destination wedding introduces people to a place they return to again and again.\n\nDownload our free Wedding Packages and Pricing Guide at executivevacations.net/wedding-packages to see how we create an experience your guests will spend years talking about.`,
      },
    },
  ];
