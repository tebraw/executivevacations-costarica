      ...
      <main style={{ paddingTop: '80px', minHeight: '100vh', background: '#f8f7f4' }}>
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            color: '#fff', lineHeight: 1.2, margin: '0 auto',
            maxWidth: '720px',
          }}>
        ...
        >
          ...
          <div style={{ position: 'sticky', top: '104px' }}>
            <div style={{
              ...
              />
              {/* Fallback dark card if image missing */}
              <div style={{ padding: '40px 32px', textAlign: 'center' }}>
                <p style={{
                  fontSize: '0.65rem', letterSpacing: '0.2em', textTransform: 'uppercase',
                  color: GOLD_LIGHT, fontWeight: 700, marginBottom: '12px',
                  fontFamily: "'DM Sans', sans-serif",
                }}>Pricing Guide 2026 – 2027</p>
                <h2 style={{
                  fontFamily: "'Playfair Display', serif",
                  color: '#fff', fontSize: 'clamp(1.5rem, 3vw, 2.2rem)',
                  fontWeight: 700, lineHeight: 1.2, marginBottom: '16px',
                }}>
                  Paradise Weddings<br /><em>Costa Rica</em>
                </h2>
                <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '0.85rem', fontFamily: "'DM Sans', sans-serif", lineHeight: 1.6 }}>
                  Package rates · Inclusions · Add-ons · Seasonal pricing
                </p>
                <div style={{ margin: '24px 0 0', display: 'flex', gap: '8px', justifyContent: 'center', flexWrap: 'wrap' }}>
                  {['Palacio Musical', 'Palacio Tropical', 'The View House'].map(v => (
                    <span key={v} style={{
                      background: `rgba(${184},${151},${46},0.15)`, border: `1px solid ${GOLD}55`,
                      borderRadius: '50px', padding: '4px 12px',
                      fontSize: '0.7rem', color: GOLD_LIGHT, fontWeight: 600,
                      fontFamily: "'DM Sans', sans-serif",
                    }}>{v}</span>
                  ))}
                </div>
