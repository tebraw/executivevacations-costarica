                ...
                <div style={{ background:'#fff', borderRadius:'16px', border:'1px solid #e9e4da', boxShadow:'0 4px 20px rgba(0,0,0,0.07)', overflow:'hidden' }}>
                  ...
                  <div style={{ padding:'18px 20px' }}>
                    ...
                    <div style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
                      ...
                      <a href={villa.pricingPdf} download
                        style={{ display:'flex', alignItems:'center', justifyContent:'center', border:'1.5px solid '+GOLD, borderRadius:'10px', padding:'12px', color:GOLD, fontSize:'0.75rem', fontWeight:700, letterSpacing:'0.08em', textTransform:'uppercase', background:'transparent', cursor:'pointer', fontFamily:"'DM Sans', sans-serif", width:'100%', textDecoration:'none' }}>
                        Pricing Guide
                      </a>
                    </div>
                  </div>
              ...
              <div style={{ position:'sticky', top:'100px' }}>
                <div style={{ background:'#fff', borderRadius:'20px', border:'1px solid #e9e4da', boxShadow:'0 8px 40px rgba(0,0,0,0.09), 0 2px 8px rgba(0,0,0,0.04)', overflow:'hidden' }}>
                  ...
                  <div style={{ padding:'0 24px 22px' }}>
                    ...
                    <a href={villa.pricingPdf} download className="w-full flex items-center justify-center gap-2 mt-2"
                      style={{ border:'1.5px solid '+GOLD, borderRadius:'10px', padding:'12px', color:GOLD, fontSize:'0.76rem', fontWeight:700, letterSpacing:'0.08em', textTransform:'uppercase', background:'transparent', cursor:'pointer', fontFamily:"'DM Sans', sans-serif", textDecoration:'none' }}>
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
